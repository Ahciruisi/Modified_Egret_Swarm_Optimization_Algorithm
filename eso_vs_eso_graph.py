...
traData = pd.read_csv('result/modifications/cec17_fitness_eso.csv')
newData = pd.read_csv('result/modifications/cec17_fitness_modified.csv')
...
ax.plot(np.arange(1200), modified, color='#942e49', alpha=0.8, label='MESOA', linestyle='--')
ax.plot(np.arange(1200), eso, color='#F75000', alpha=0.8, label='ESOA', linestyle='--')
ax.legend(loc="upper right", fontsize=24)
ax.set_xlabel('Iteration', fontsize=26)
ax.set_ylabel('Fitness', fontsize=26)
...
axins.plot(np.arange(1200), modified, color='#942e49', alpha=0.8, label='MESOA', linestyle='--')
axins.plot(np.arange(1200), eso, color='#F75000', alpha=0.8, label='ESOA', linestyle='--')
